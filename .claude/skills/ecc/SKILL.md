...
name: ecc
description: >
  Layer ECC (github.com/affaan-m/ECC v2.2.0) instalado en MV Cliente IA: reglas de estilo, testing,
...
1. Correr el gate real del repo y **pegar la salida cruda**, no un resumen:
   ...
   ```
   CI tiene además una corrida end-to-end y un humo de la ventana Electron. Que pytest pase no prueba que la app de escritorio abra.
